...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'crosslegallab',// 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'crosslegallab',// 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://crosslegallab.com',// 网站地址
  ...
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK ||  'wu',// 备案查询链接，如果用了萌备等备案请在这里填写
  BEI_AN_GONGAN: process.env.NEXT_PUBLIC_BEI_AN_GONGAN || 'wu', // 公安备案号，例如 '浙公网安备3xxxxxxxx8号'
